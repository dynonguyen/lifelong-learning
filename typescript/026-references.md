...
- [TypeScript Release Notes](https://devblogs.microsoft.com/typescript/) - Latest features
...
- [Type Challenges](https://github.com/type-challenges/type-challenges) - Practice type gymnastics
- [TypeScript Course by Matt Pocock](https://www.youtube.com/@maaborern) - YouTube tutorials
- [Execute Program](https://www.executeprogram.com/courses/typescript) - Interactive course

## Tools

- [ts-node](https://typestrong.org/ts-node/) - Run TypeScript directly
- [tsx](https://github.com/privatenumber/tsx) - Fast TypeScript executor
- [tsc-watch](https://github.com/gilamran/tsc-watch) - Watch mode with callbacks
- [TypeDoc](https://typedoc.org/) - Documentation generator
- [ts-prune](https://github.com/nadeesha/ts-prune) - Find unused exports

## Community

- [TypeScript Discord](https://discord.gg/typescript) - Official Discord
